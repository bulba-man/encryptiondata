...
$replacements = [
    'AET\\\\EncryptionData\\\\' => function () use(&$values) { return str_replace('\\', '\\\\', $values['psr4_namespace']) . '\\\\'; },
    'Nikita Dmitrievich'                 => function () use(&$values) { return $values['author_name']; },
    'bulba_man'             => function () use(&$values) { return $values['author_github_username']; },
    'http://p-style.by/'              => function () use(&$values) { return $values['author_website'] ?: ('https://github.com/' . $values['author_github_username']); },
    'nikitadm@tut.by'                => function () use(&$values) { return $values['author_email'] ?: ($values['author_github_username'] . '@example.com'); },
    'AET'                      => function () use(&$values) { return $values['package_vendor']; },
    'EncryptionData'                => function () use(&$values) { return $values['package_name']; },
    ''         => function () use(&$values) { return $values['package_description']; },
